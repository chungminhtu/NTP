            ...
            if (itemType != ListItemType.Header && itemType != ListItemType.Footer) {
                ...
                for( int i = 0; i < cell.Controls.Count; i++ ) {
                    ...
                    if ( innerControl is LinkButton ) {
                        ...
                        if ( 
                          ( oldLink.CommandName == "Edit"   && this.EditMessage   != String.Empty ) ||
                          ( oldLink.CommandName == "Update" && this.UpdateMessage != String.Empty ) ||
                          ( oldLink.CommandName == "Cancel" && this.CancelMessage != String.Empty ) ) {
                    ...
                    if ( innerControl is Button ) {
                        ...
                        if ( 
                          ( oldButton.CommandName == "Edit"   && this.EditMessage   != String.Empty ) ||
                          ( oldButton.CommandName == "Update" && this.UpdateMessage != String.Empty ) ||
                          ( oldButton.CommandName == "Cancel" && this.CancelMessage != String.Empty ) ) {
