...
Public Class NTP_CU_TTB_EXPORT_DAL
    Private Shared _thisInstance As NTP_CU_TTB_EXPORT_DAL
    ...
    Public Shared Function Instance() As NTP_CU_TTB_EXPORT_DAL
        '
        ...
        SyncLock PadLock
            ...
            If _thisInstance Is Nothing Then
                _thisInstance = New NTP_CU_TTB_EXPORT_DAL
            End If
            '
    ...
    Public Sub InsertItem(ByVal bibi As NTP_CU_TTB_EXPORT_Info)
        SqlHelper.ExecuteNonQuery(SQLConnectionString, _
         "NTP_CU_TTB_EXPORT_Insert", _
    ...
    Public Sub UpdateItem(ByVal bibi As NTP_CU_TTB_EXPORT_Info)
        SqlHelper.ExecuteNonQuery(SQLConnectionString, _
         "NTP_CU_TTB_EXPORT_Update", _
         GetNull(bibi.ID_EXPORT), _
         GetNull(bibi.ID_KHO), _
         GetNull(bibi.ID_THIETBI), _
         GetNull(bibi.ID_NGUONKINHPHI), _
    ...
    Public Function Search(ByVal ID_KHO As Integer, ByVal sMA_PHIEU As String, ByVal dtFromDate As Date, ByVal dtToDate As Date, ByVal iNguonKinhPhi As Integer, ByVal ID_LYDONHAPXUAT As Integer, ByVal ID_DONVI_NHAN As Integer) As DataSet
        Return SqlHelper.ExecuteDataset(SQLConnectionString, _
        "NTP_CU_TTB_EXPORT_Search", GetNull(ID_KHO), GetNull(sMA_PHIEU), GetNull(dtFromDate), GetNull(dtToDate), GetNull(iNguonKinhPhi), GetNull(ID_LYDONHAPXUAT), GetNull(ID_DONVI_NHAN))
    End Function
End Class
