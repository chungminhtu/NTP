Public Class NTP_CU_HC_IMPORT_BO

    Public Sub InsertItem(ByVal objData As NTP_CU_HC_IMPORT_Info)
        NTP_CU_HC_IMPORT_DAL.Instance.InsertItem(objData)
    End Sub

    Public Sub UpdateItem(ByVal objData As NTP_CU_HC_IMPORT_Info)
        NTP_CU_HC_IMPORT_DAL.Instance.UpdateItem(objData)
    End Sub

    Public Sub DeleteItem(ByVal ID_IMPORT As Double)
        NTP_CU_HC_IMPORT_DAL.Instance.DeleteItem(ID_IMPORT)
    End Sub

    Public Function SelectItem(ByVal ID_IMPORT As Double) As NTP_CU_HC_IMPORT_Info
        Dim ds As DataSet = NTP_CU_HC_IMPORT_DAL.Instance.SelectItem(ID_IMPORT)
        Dim retVal As NTP_CU_HC_IMPORT_Info
        If ds.Tables(0).Rows.Count > 0 Then
            Dim row As DataRow = ds.Tables(0).Rows(0)
            retVal = New NTP_CU_HC_IMPORT_Info
    ...
    Public Function SelectAllItems() As DataSet
        Return NTP_CU_HC_IMPORT_DAL.Instance.SelectAllItems()
    End Function
    ...
    Public Function Search(ByVal ID_KHO As Integer, ByVal sMA_PHIEU As String, ByVal dtFromDate As Date, ByVal dtToDate As Date, ByVal iNguonKinhPhi As Integer) As DataSet
        Return NTP_CU_HC_IMPORT_DAL.Instance.Search(ID_KHO, sMA_PHIEU, dtFromDate, dtToDate, iNguonKinhPhi)
    End Function
