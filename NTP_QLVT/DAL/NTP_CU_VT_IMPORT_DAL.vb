...
Public Class NTP_CU_VT_IMPORT_DAL
    Private Shared _thisInstance As NTP_CU_VT_IMPORT_DAL
    ...
    Public Shared Function Instance() As NTP_CU_VT_IMPORT_DAL
        '
        ...
        SyncLock PadLock
            ...
            If _thisInstance Is Nothing Then
                _thisInstance = New NTP_CU_VT_IMPORT_DAL
            End If
            '
    ...
    Public Sub InsertItem(ByVal bibi As NTP_CU_VT_IMPORT_Info)
        SqlHelper.ExecuteNonQuery(SQLConnectionString, _
         "NTP_CU_VT_IMPORT_Insert", _
    ...
    Public Sub UpdateItem(ByVal bibi As NTP_CU_VT_IMPORT_Info)
        SqlHelper.ExecuteNonQuery(SQLConnectionString, _
         "NTP_CU_VT_IMPORT_Update", _
         GetNull(bibi.ID_IMPORT), _
         GetNull(bibi.ID_KHO), _
         GetNull(bibi.ID_VATTU), _
         GetNull(bibi.ID_NGUONKINHPHI), _
    ...
    Public Function Search(ByVal ID_KHO As Integer, ByVal sMA_PHIEU As String, ByVal dtFromDate As Date, ByVal dtToDate As Date, ByVal iNguonKinhPhi As Integer) As DataSet
        Return SqlHelper.ExecuteDataset(SQLConnectionString, _
         "NTP_CU_VT_IMPORT_Search", ID_KHO, GetNull(sMA_PHIEU), GetNull(dtFromDate), GetNull(dtToDate), GetNull(iNguonKinhPhi))
    End Function
End Class
