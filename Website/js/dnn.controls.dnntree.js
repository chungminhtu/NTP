...
{var img=document.createElement('IMG');img.src=this.sysImgPath+'spacer.gif';img.width=width;img.style.width=width;img.style.height='1';return img;},renderText:function(tNode)
...
span.title=tNode.toolTip;if(tNode.enabled)
{if(this.checkBoxes)
