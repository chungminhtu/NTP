...
fadeSlideShow.routines={
	...
	getSlideHTML:function(imgelement){
		var layerHTML=(imgelement[0])? '<a href="'+imgelement[0]+'" rel="lightbox['+imgelement[2]+']" style="text-decoration: none">\n' : '' //hyperlink slide?
		layerHTML+='<img src="'+imgelement[0]+'" style="border-width:0; border-color:White; width:400px" ToolTip='+imgelement[3]+'/>\n'
		layerHTML+=(imgelement[0])? '</a>\n' : ''
