<%@ Control language="vb" Inherits="YourCompany.Modules.NTP_KD_BAOCAOKQKD_IN.EditNTP_KD_BAOCAOKQKD_IN" CodeFile="EditNTP_KD_BAOCAOKQKD_IN.ascx.vb" AutoEventWireup="false" Explicit="True" %>
