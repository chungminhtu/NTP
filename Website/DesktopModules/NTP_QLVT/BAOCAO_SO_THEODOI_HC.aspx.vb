...
Public Class BAOCAO_SO_THEODOI_HC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ds = obj.SO_THEODOI_HOACHAT(ID_KHO, dtDateFrom, dtDateTo, ID_VATTU)

        Dim rpt As New ReportDocument
        Dim sPath As String
        sPath = Me.Request.PhysicalApplicationPath & NTP_Common.Configuration.ReportDirectory & "\SoTheodoi_HC.rpt"
        rpt.Load(sPath)
