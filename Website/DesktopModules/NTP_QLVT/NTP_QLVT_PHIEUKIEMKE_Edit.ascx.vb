...
Public Class NTP_QLVT_PHIEUKIEMKE_Edit
    Inherits DotNetNuke.Entities.Modules.ModuleSettingsBase

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim obj As New NTP_QLVT.NTP_QLVT_KIEMKE_BO
        Dim inf As New NTP_QLVT.NTP_QLVT_KIEMKE_Info
        Try
    ...
    Private Sub BindGrid(ByVal iID_PHIEUKIEMKE As Double)
        Dim obj As New NTP_QLVT.NTP_QLVT_KIEMKE_CHITIET_BO
        Try
    ...
    Private Sub BindComboTRANGTHAI()
        Dim obj As New NTP_QLVT.NTP_QLVT_DM_TRANGTHAI_BO
        Try
    ...
    Protected Sub cmdAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        ...
        Try
            ...
            iStatus = objKy.KiemTraKy(Me.CurrentUserStock.ID_KHO_QLVT, CInt(dtNgayKK.Month), CInt(dtNgayKK.Year))
            ...
            inf.ID_KHO = Me.CurrentUserStock.ID_KHO_QLVT
    ...
    Protected Sub cmdSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        Dim obj As New NTP_QLVT.NTP_QLVT_KIEMKE_CHITIET_BO
        Dim inf As New NTP_QLVT.NTP_QLVT_KIEMKE_CHITIET_Info
        Try
            'Save detail
