<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NTP_QLVT_PHIEUXUAT_List.ascx.vb" Inherits="NTP_QLVT_PHIEUXUAT_List" %>
...
<asp:ImageButton id="cmdEdit" runat="server" __designer:wfdid="w6" CommandName="edit" ImageUrl="~/images/edit.gif" CausesValidation="False"></asp:ImageButton> 
                        ...
                        <asp:BoundColumn DataField="NGUOI_XUAT" HeaderText="Người viết phiếu">
                            <headerstyle width="15%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="MO_TA" HeaderText="Nguồn kinh ph&#237;">
                            <headerstyle width="20%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="TEN_KHONHAP" HeaderText="Kho được xuất">
                            <headerstyle width="10%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="LYDO_NHAPXUAT" HeaderText="L&#253; do nhập xuất">
                            <headerstyle width="10%" />
                        </asp:BoundColumn>
