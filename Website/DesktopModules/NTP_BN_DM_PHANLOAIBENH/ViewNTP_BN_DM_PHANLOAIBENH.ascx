<%@ Control language="vb" Inherits="YourCompany.Modules.NTP_BN_DM_PHANLOAIBENH.ViewNTP_BN_DM_PHANLOAIBENH" CodeFile="ViewNTP_BN_DM_PHANLOAIBENH.ascx.vb" AutoEventWireup="false" Explicit="True" %>
...
<asp:ImageButton id="cmdEdit" runat="server" CommandName="edit" ImageUrl="~/images/edit.gif"></asp:ImageButton>
                    ...
                    <asp:BoundColumn DataField="ID_PhanLoaiBenh" HeaderText="ID_PhanLoaiBenh" Visible="False"></asp:BoundColumn>
                 
                    <asp:BoundColumn DataField="ten_PhanLoaiBenh" HeaderText="T&#234;n phân loại bệnh">
