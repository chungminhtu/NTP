...
Public Class VT_IMPORT_Edit
    ...
    Private Sub SetInfo(ByVal ID As Integer)
        Dim obj As New NTP_QLVT.NTP_CU_VT_IMPORT_BO
        Dim inf As New NTP_QLVT.NTP_CU_VT_IMPORT_Info
    ...
    Private Function GetInfo() As NTP_QLVT.NTP_CU_VT_IMPORT_Info
        Dim inf As New NTP_QLVT.NTP_CU_VT_IMPORT_Info
