...
Partial Class VT_KHO_BC_SUDUNG
    ...
    Private Sub BindComboThuoc()
        Try
            cboThuoc.DataSource = (New NTP_QLVT.NTP_QLVT_DM_VATTU_BO).SelectAllItems(NTP_Common.enuTYPE_VATTU_HOACHAT.VATTU)
            cboThuoc.DataBind()
    ...
    Protected Sub cmdView_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdView.Click
        ...
        url = Request.ApplicationPath & "/DesktopModules/NTP_CU_VATTU/VT_KHO_BC_SUDUNG_VIEW.aspx?ID_KHO=" & Me.CurrentUserStock.ID_KHO_THUOC & "&LOAIKY=" & id_loaiky & "&KY=" & ky & "&NAM=" & txtNam.Text.Trim & "&ID_NGUONKP=" & cboNguonKP.SelectedValue & "&ID_vattu=" & cboThuoc.SelectedValue   ' "./DesktopModules/VTP_VIEWREPORT/ShowReport.aspx"
