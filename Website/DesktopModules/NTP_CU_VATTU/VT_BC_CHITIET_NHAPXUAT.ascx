<%@ Control Language="VB" AutoEventWireup="false" CodeFile="VT_BC_CHITIET_NHAPXUAT.ascx.vb" Inherits="VT_BC_CHITIET_NHAPXUAT" %>
<table  class = "ntp_table_main" width=100%>
    ...
    <tr>
        <td style="height: 24px" width="15%">
            <asp:Label ID="Label5" runat="server" CssClass="ntp_label" Text="Loại vật tư"></asp:Label></td>
        <td style="height: 24px" width="85%">
