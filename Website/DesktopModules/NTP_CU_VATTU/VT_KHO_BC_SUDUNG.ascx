<%@ Control Language="VB" AutoEventWireup="false" CodeFile="VT_KHO_BC_SUDUNG.ascx.vb" Inherits="VT_KHO_BC_SUDUNG" %>
<table  class = "ntp_table_main" width=100%>
    ...
    <tr>
        <td style="height: 24px" width="15%">
            <asp:Label ID="Label5" runat="server" CssClass="ntp_label" Text="Vật tư"></asp:Label></td>
        <td style="height: 24px" width="85%">
