...
Public Class HC_EXPORT_Edit
    ...
    Private Sub BindComboThuoc()
        ...
        Try
            ds = (New NTP_QLVT.NTP_QLVT_DM_VATTU_BO).SelectAllItems(NTP_Common.enuTYPE_VATTU_HOACHAT.HOACHAT)
    ...
    Private Sub SetInfo(ByVal ID As Integer)
        ...
        Dim inf As New NTP_QLVT.NTP_CU_HC_EXPORT_Info
    ...
    Private Function GetInfo() As NTP_QLVT.NTP_CU_HC_EXPORT_Info
        Dim inf As New NTP_QLVT.NTP_CU_HC_EXPORT_Info
    ...
    Protected Sub cmdCheckLo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdCheckLo.Click
        Dim obj As New NTP_QLVT.NTP_CU_HC_KHO_BO
