...
Partial Class HC_BC_CHITIET_NHAPXUAT
    ...
    Protected Sub cmdView_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdView.Click
        ...
        url = Request.ApplicationPath & "/DesktopModules/NTP_CU_hoachat/hc_bc_chitiet_nhapxuat_view.aspx?ID_KHO=" & Me.CurrentUserStock.ID_KHO_THUOC & "&thang=" & ky & "&NAM=" & txtNam.Text.Trim & "&ID_NGUONKP=" & cboNguonKP.SelectedValue & "&ID_vattu=" & cboThuoc.SelectedValue   ' "./DesktopModules/VTP_VIEWREPORT/ShowReport.aspx"
