...
Public Class HC_bc_chitiet_nhapxuat_view
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        sPath = Me.Request.PhysicalApplicationPath & NTP_Common.Configuration.ReportDirectory & "\cu_hc_bc_chitiet_nhapxuat.rpt"
        rpt.Load(sPath)
