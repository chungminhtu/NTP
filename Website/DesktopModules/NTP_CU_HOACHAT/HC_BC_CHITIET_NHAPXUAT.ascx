<%@ Control Language="VB" AutoEventWireup="false" CodeFile="HC_BC_CHITIET_NHAPXUAT.ascx.vb" Inherits="HC_BC_CHITIET_NHAPXUAT" %>
<table  class = "ntp_table_main" width=100%>
    ...
    <tr>
        <td style="height: 24px" width="15%">
            <asp:Label ID="Label5" runat="server" CssClass="ntp_label" Text="Loại hóa chất"></asp:Label></td>
        <td style="height: 24px" width="85%">
