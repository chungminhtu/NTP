<%@ Control language="vb" Inherits="YourCompany.Modules.NTP_BN_DM_DOITUONG.ViewNTP_BN_DM_DOITUONG" CodeFile="ViewNTP_BN_DM_DOITUONG.ascx.vb" AutoEventWireup="false" Explicit="True" %>
...
<asp:ImageButton id="cmdEdit" runat="server" CommandName="edit" ImageUrl="~/images/edit.gif"></asp:ImageButton>
                    ...
                    <asp:BoundColumn DataField="ID_DoiTuong" HeaderText="ID_DoiTuong" Visible="False"></asp:BoundColumn>
                 
                    <asp:BoundColumn DataField="ten_DoiTuong" HeaderText="T&#234;n đối tượng">
