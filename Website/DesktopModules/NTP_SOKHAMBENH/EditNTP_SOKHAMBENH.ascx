<%@ Control language="vb" Inherits="YourCompany.Modules.NTP_SOKHAMBENH.EditNTP_SOKHAMBENH" CodeFile="EditNTP_SOKHAMBENH.ascx.vb" AutoEventWireup="false" Explicit="True" %>
