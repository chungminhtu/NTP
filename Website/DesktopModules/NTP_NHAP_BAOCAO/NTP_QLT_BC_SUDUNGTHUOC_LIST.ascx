 ...
 <table  class = "ntp_table_main" width="100%">
     ...
     <tr>
         <td colspan="2" width="15%">
             <asp:Label ID="Label5" runat="server" CssClass="ntp_comment" Text="Chú ý: <br>Chỉ được phép chọn 1 báo cáo để phê duyệt" Visible="False"></asp:Label></td>
     </tr>
     <tr>
...
<asp:ImageButton id="cmdEdit" runat="server" CommandName="edit" ImageUrl="~/images/edit.gif" CausesValidation="False"></asp:ImageButton> 
                     ...
                     <asp:TemplateColumn>
                         <itemtemplate>
                        <asp:Button id="cmdBaoCao" runat="server" Text="BC Tuyến Miền" CssClass="ntp_button" CommandName="baocao_Mien" __designer:wfdid="w2"></asp:Button> 
                        </itemtemplate>
                         <headerstyle width="10%" />
                     </asp:TemplateColumn>
                     <asp:TemplateColumn>
                         <itemtemplate>
                        <asp:Button id="cmdBaoCaoHuyen" runat="server" Text="BC Tuyến Huyện" CssClass="ntp_button" CommandName="baocao_Huyen"></asp:Button> 
                        </itemtemplate>
                         <headerstyle width="10%" />
                     </asp:TemplateColumn>
                 </Columns>
