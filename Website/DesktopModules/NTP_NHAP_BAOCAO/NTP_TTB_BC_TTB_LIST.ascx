<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NTP_TTB_BC_TTB_LIST.ascx.vb" Inherits="NTP_TTB_BC_TTB_LIST" %>
...
<asp:Panel ID="pnlAll" runat=server Width="100%">
 <table  class = "ntp_table_main" width="100%">
     ...
     <tr>
         <td width="15%">
             <asp:Label ID="Label1" runat="server" CssClass="ntp_label" Text="Năm" Width="47px"></asp:Label></td>
         <td width="85%">
...
<asp:ImageButton id="cmdEdit" runat="server" CommandName="edit" ImageUrl="~/images/edit.gif" CausesValidation="False"></asp:ImageButton> 
                     ...
                     <asp:BoundColumn HeaderText="6 th&#225;ng" DataField="QUY" Visible="False">
