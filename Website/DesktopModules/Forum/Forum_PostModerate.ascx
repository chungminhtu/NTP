			...
			<td valign="top" align="left" width="100%"><asp:datalist id="lstPost" runat="server" DataKeyField="PostID" CellPadding="0" Width="100%">
					<ItemTemplate>
						<table width="100%" cellpadding="0" cellspacing="0" border="0" runat="server" id="tblPostList">
							<tr>
								<td class="Forum_AltHeader" width="100%" colspan="2">
									<table cellpadding="0" cellspacing="0" border="0" width="100%" id="">
										<tr>
											...
											<td align="left" width="100%">
												&nbsp;
												<asp:hyperlink CssClass="Forum_AltHeaderText" NavigateUrl='<%# ThreadLink(CType(DataBinder.Eval(Container.DataItem, "ThreadID"), Integer), CType(DataBinder.Eval(Container.DataItem, "ForumID"), Integer), CType(DataBinder.Eval(Container.DataItem, "ParentPostID"), Integer))  %>' runat="server" ID="lblSubject" Target="_blank" Text='<%# FormatCreatedDate(DataBinder.Eval(Container.DataItem, "CreatedDate")) %>' />
											</td>
										</tr>
									</table>
								</td>
