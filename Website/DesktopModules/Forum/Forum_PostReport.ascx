	...
	<table class="" id="tblMain" cellspacing="0" cellpadding="0" width="100%"
		...
		<tr>
			...
			<td class="Forum_Row_AdminR">
				<asp:DropDownList id="ddlReportTemplate" runat="server" Width="250px" AutoPostBack="True" CssClass="Forum_NormalTextBox"></asp:DropDownList></td>
		</tr>
		<tr>
			<td class="Forum_Row_AdminL" valign="top">
				<span class="Forum_Row_AdminText">
        ...
        <tr>
            <td align="center" class="Forum_Row_Admin" colspan="2">
                <asp:Label ID="lblAlreadyReported" runat="server" CssClass="NormalRed" Visible="False" resourcekey="lblAlreadyReported"></asp:Label></td>
        </tr>
		<tr>
			<td class="Forum_Row_Admin_Foot" align="center" colspan="2">
				...
				</asp:linkbutton>&nbsp;<asp:linkbutton cssclass="CommandButton" id="cmdReport" runat="server" resourcekey="cmdReport"></asp:linkbutton></td>
		</tr>
	</table>
