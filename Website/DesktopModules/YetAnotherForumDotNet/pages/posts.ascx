        ...
        <tr>
            <td class="post">
                <yaf:MyLinkButton runat="server" Enabled="<%#CanVote%>" CommandName="vote" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ChoiceID") %>'
                    Text='<%# DataBinder.Eval(Container.DataItem, "Choice") %>' /></td>
            <td class="post" align="center">
                <%# DataBinder.Eval(Container.DataItem, "Votes") %>
            </td>
            <td class="post">
                <nobr><img src="<%# GetThemeContents("VOTE","LCAP") %>"><img src='<%# GetThemeContents("VOTE","BAR") %>' height=12px width='<%# VoteWidth(Container.DataItem) %>%'><img src='<%# GetThemeContents("VOTE","RCAP") %>'></nobr>
