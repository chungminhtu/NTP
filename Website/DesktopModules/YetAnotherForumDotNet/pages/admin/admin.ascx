...
<yaf:adminmenu runat="server" id="Adminmenu1">
	<asp:repeater id="ActiveList" runat="server">
		...
		<ItemTemplate>
			<tr>
				<td class="post"><%# HtmlEncode(DataBinder.Eval(Container.DataItem, "Name"))%></td>
	...
	<asp:repeater id="UserList" runat="server">
		...
		<ItemTemplate>
			<tr>
				<td class="post"><%# HtmlEncode(DataBinder.Eval(Container.DataItem,"Name")) %></td>
				<td class="post"><%# HtmlEncode(DataBinder.Eval(Container.DataItem,"Email")) %></td>
				<td class="post"><%# HtmlEncode(DataBinder.Eval(Container.DataItem,"Location")) %></td>
