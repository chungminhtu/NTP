<%@ Control Language="VB" AutoEventWireup="false" CodeFile="TTB_BC_CHITIET_NHAPXUAT.ascx.vb" Inherits="TTB_BC_CHITIET_NHAPXUAT" %>
<table  class = "ntp_table_main" width=100%>
    ...
    <tr>
        <td style="height: 24px" width="15%">
            <asp:Label ID="Label5" runat="server" CssClass="ntp_label" Text="Loại thiết bị"></asp:Label></td>
        <td style="height: 24px" width="85%">
            <asp:DropDownList ID="cboThuoc" runat="server" CssClass="ntp_combobox" TabIndex="2" Width="400px" DataTextField="TEN_THIETBI" DataValueField="ID_THIETBI">
            </asp:DropDownList></td>
    </tr>
    <tr>
        <td style="height: 24px" width="15%">
