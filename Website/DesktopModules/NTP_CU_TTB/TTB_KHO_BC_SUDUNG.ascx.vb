...
Partial Class TTB_KHO_BC_SUDUNG
    ...
    Protected Sub cmdView_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdView.Click
        ...
        url = Request.ApplicationPath & "/DesktopModules/NTP_CU_TTB/TTB_KHO_BC_SUDUNG_VIEW.aspx?ID_KHO=" & Me.CurrentUserStock.ID_KHO_THUOC & "&LOAIKY=" & id_loaiky & "&KY=" & ky & "&NAM=" & txtNam.Text.Trim & "&ID_NGUONKP=" & cboNguonKP.SelectedValue & "&ID_THIETBI=" & cboThuoc.SelectedValue   ' "./DesktopModules/VTP_VIEWREPORT/ShowReport.aspx"
