<%@ Control Language="VB" AutoEventWireup="false" CodeFile="TTB_IMPORT_List.ascx.vb" Inherits="TTB_IMPORT_List" %>
...
<asp:ImageButton id="cmdEdit" runat="server" __designer:wfdid="w6" CommandName="edit" ImageUrl="~/images/edit.gif" CausesValidation="False"></asp:ImageButton> 
                        ...
                        <asp:BoundColumn DataField="TEN_THIETBI" HeaderText="T&#234;n thiết bị"></asp:BoundColumn>
