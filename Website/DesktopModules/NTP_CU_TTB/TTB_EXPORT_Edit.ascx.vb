...
Public Class TTB_EXPORT_Edit
    ...
    Private Sub SetInfo(ByVal ID As Integer)
        Dim obj As New NTP_QLTTB.NTP_CU_TTB_EXPORT_BO
        Dim inf As New NTP_QLTTB.NTP_CU_TTB_EXPORT_Info
    ...
    Private Function GetInfo() As NTP_QLTTB.NTP_CU_TTB_EXPORT_Info
        Dim inf As New NTP_QLTTB.NTP_CU_TTB_EXPORT_Info
