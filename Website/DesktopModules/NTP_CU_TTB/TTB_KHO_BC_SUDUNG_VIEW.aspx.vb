...
Public Class TTB_KHO_BC_SUDUNG_VIEW
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        sPath = Me.Request.PhysicalApplicationPath & NTP_Common.Configuration.ReportDirectory & "\cu_ttb_bc_sudungttb_donvi_cuongnh2.rpt"
        rpt.Load(sPath)
