...
Public Class TTB_IMPORT_Edit
    ...
    Private Sub BindComboThuoc()
        ...
        Try
            ds = (New NTP_QLTTB.NTP_QLTTB_DM_THIETBI_BO).SelectAllItems
    ...
    Private Sub SetInfo(ByVal ID As Integer)
        Dim obj As New NTP_QLTTB.NTP_CU_TTB_IMPORT_BO
        Dim inf As New NTP_QLTTB.NTP_CU_TTB_IMPORT_Info
        ...
        Me.cboThuoc.SelectedValue = inf.ID_THIETBI
    ...
    Private Function GetInfo() As NTP_QLTTB.NTP_CU_TTB_IMPORT_Info
        Dim inf As New NTP_QLTTB.NTP_CU_TTB_IMPORT_Info
        ...
        inf.ID_THIETBI = Me.cboThuoc.SelectedValue
        ...
        inf.LOAI_NHAP = Me.cboLYDO_NHAPXUAT.SelectedValue
        Return inf
    End Function
