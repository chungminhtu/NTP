<%@ Control Language="VB" AutoEventWireup="false" CodeFile="TTB_EXPORT_List.ascx.vb" Inherits="TTB_EXPORT_List" %>
...
<asp:ImageButton id="cmdEdit" runat="server" __designer:wfdid="w6" CommandName="edit" ImageUrl="~/images/edit.gif" CausesValidation="False"></asp:ImageButton> 
                        ...
                        <asp:BoundColumn DataField="TEN_THIETBI" HeaderText="Thiết bị"></asp:BoundColumn>
