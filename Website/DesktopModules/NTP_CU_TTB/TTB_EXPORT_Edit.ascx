<%@ Control Language="VB" AutoEventWireup="false" CodeFile="TTB_EXPORT_Edit.ascx.vb" Inherits="TTB_EXPORT_Edit" %>
        ...
        <table class="ntp_table_main" width="100%">
            ...
            <tr>
                <td width="20%" style="height: 24px">
                    <asp:Label ID="Label3" runat="server" CssClass="ntp_label" Text="Thiết bị"></asp:Label>
                    <asp:Label ID="Label10" runat="server" CssClass="ntp_require" Text="*"></asp:Label></td>
                <td style="width: 30%; height: 24px;">
                    <asp:DropDownList ID="cboThuoc" runat="server" CssClass="ntp_combobox" DataTextField="TEN_THIETBI"
                        DataValueField="ID_THIETBI" TabIndex="10" Width="100%">
                    </asp:DropDownList></td>
                <td width="20%" style="height: 24px">
                </td>
