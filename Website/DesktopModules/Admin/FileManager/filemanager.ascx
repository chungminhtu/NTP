					    ...
					    <asp:datagrid id="dgFileList" runat="server" Width="100%" GridlInes="Horizontal" AllowPaging="True"
							...
							<Columns>
								...
								<asp:TemplateColumn>
									...
									<ItemTemplate>
										<asp:ImageButton Runat="server" ID="lnkEditFile" Visible = "<%# HasWritePermission %>" OnCommand="lnkEditFile_Command" resourcekey="RenameFileImg.AlternateText" ImageUrl="~/images/FileManager/DNNExplorer_Edit.gif"  />
									</ItemTemplate>
									<EditItemTemplate>
								...
								<asp:TemplateColumn>
									<ItemStyle HorizontalAlign="Right" Width="1%"></ItemStyle>
									<ItemTemplate>
										<asp:ImageButton Runat="server" ID="lnkDeleteFile" Visible = "<%# HasWritePermission %>" OnCommand="lnkDeleteFile_Command" resourcekey="DeleteFileImg.AlternateText" ImageUrl="~/images/FileManager/DNNExplorer_trash.gif" CommandName='<%# DataBinder.Eval(Container, "DataItem.FileName")%>' />
									</ItemTemplate>
									<EditItemTemplate>
								...
								<asp:TemplateColumn>
									<ItemStyle HorizontalAlign="Right" Width="1%"></ItemStyle>
									<ItemTemplate>
										<asp:image id="lnkUnzip" style="CURSOR: pointer" runat="server" Visible = "<%# HasWritePermission %>" name="lnkMove" ImageUrl="~/images/FileManager/DNNExplorer_Unzip.gif" resourcekey="UnzipFileImg.AlternateText" filename='<%# DataBinder.Eval(Container, "DataItem.FileName")%>' extension='<%# DataBinder.Eval(Container, "DataItem.Extension")%>' />
									</ItemTemplate>
								</asp:TemplateColumn>
...
<asp:panel id="pnlSecurity" Runat="server" Visible="False" HorizontalAlign="Left">
    ...
    <table id="tblSecurity" cellspacing="2" cellpadding="2" summary="Security Details Design Table" border="0" runat="server">
		<tr>
			<td class="SubHead" valign="top" width="150"><br/><dnn:label id="plPermissions" runat="server" controlname="ctlPermissions"/></td>
			<td>
				<table cellspacing="0" cellpadding="0" border="0">
					<tr>
						<td><dnn:folderpermissionsgrid id="dgPermissions" runat="server"/></td>
					</tr>
				</table>
			</td>
		</tr>
