<%@ Control Inherits="DotNetNuke.Modules.Admin.Host.HostSettings" Language="vb" AutoEventWireup="false"
    Explicit="True" CodeFile="HostSettings.ascx.vb" %>
                    ...
                    <td style="vertical-align: top; width: 600px">
                        ...
                        <table id="tblConfiguration" cellspacing="2" cellpadding="2" summary="Configuration Design Table"
                            ...
                            <tr>
                                <td class="SubHead" style="width: 250px">
                                    <dnn:Label ID="plVersion" Text="DotNetNuke Version:" ControlName="lblVersion" runat="server" />
                                </td>
                                <td>
                                    <asp:Label ID="lblVersion" runat="server" CssClass="NormalBold" />
                                </td>
                            </tr>
                            <tr>
                                <td class="SubHead" style="width: 250px">
                                    <dnn:Label ID="plUpgrade" Text="Check For Upgrades?" ControlName="chkUpgrade" runat="server" />
                                </td>
                                <td>
                                    <asp:CheckBox ID="chkUpgrade" runat="server" CssClass="NormalBold" />
                                </td>
                            </tr>
                            <tr>
                                <td class="SubHead" style="width: 250px">
                                    <dnn:Label ID="plAvailable" Text="Upgrade Available?" runat="server" />
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    &nbsp;&nbsp;
                                    <dnn:CommandButton ID="cmdUpgradeFramework" runat="server" ImageUrl="~/images/action_refresh.gif" ResourceKey="UpgradeFramework" CausesValidation="false" Visible="false" />
                                </td>
                            </tr>
                            <tr>
                                <td class="SubHead" style="width: 250px">
                            ...
                            <tr>
                                <td class="SubHead" style="width: 250px">
                                    <dnn:Label ID="plWebFarm" Text="Web Farm Enabled?" ControlName="lblWebFarm" runat="server" />
                                </td>
                                <td>
                        ...
                        <table id="tblHost" cellspacing="2" cellpadding="2" summary="Site Details Design Table"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cboHostDefaultDocType" runat="server" Width="150">
                            ...
                            <tr>
                                <td align="center" colspan="2">
                                    ...
                                    <dnn:CommandButton ID="cmdUploadContainer" ResourceKey="ContainerUpload" runat="server"
                                        CssClass="CommandButton" ImageUrl="~/images/up.gif" />
                                    &nbsp;&nbsp;
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 600px">
                        ...
                        <table id="tblPerformance" cellspacing="2" cellpadding="2" summary="Performance Design Table"
                            ...
                            <tr>
                                <td class="SubHead" width="200" valign="top">
                                    <dnn:Label ID="plCacheMethod" runat="server" ControlName="cboCacheMethod" Text="Cache Method:">
                                    </dnn:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cboPerformance" runat="server" Style="width: 250px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cboCacheability" runat="server" Style="width: 250px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cboCompression" runat="server" Style="width: 250px">
                        ...
                        <table id="tblOther" cellspacing="2" cellpadding="2" summary="Appearance Design Table"
                            ...
                            <tr visible="false">
                                <td class="SubHead" style="width: 250px">
                                    <dnn:Label ID="plSkinUpload" Text="Skin Upload Permission:" ControlName="optSkinUpload"
                                        runat="server" />
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cboSchedulerMode" runat="server" Width="250px">
