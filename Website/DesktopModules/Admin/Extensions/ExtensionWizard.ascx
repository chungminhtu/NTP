            ...
            <table id="tblPackage" runat="server" cellspacing="2" cellpadding="4" broder="0">
                <tr id="trExtensionType" runat="server">
                    ...
                    <td class="NormalTextBox" style="width:325px">
                        <asp:DropDownList ID="cboExtensionType" runat="server" DataTextField="Description" DataValueField="PackageType" />
                    </td>
                </tr>
                <tr id="trLanguagePackType" runat="server">
                    ...
                    <td class="NormalTextBox" style="width:325px">
                        <asp:RadioButtonList ID="rbPackageType" runat="server" RepeatDirection="Horizontal">
                            <asp:ListItem Value="CoreLanguagePack" resourcekey="Core" />
                            <asp:ListItem Value="ExtensionLanguagePack" resourcekey="Package" />
                        </asp:RadioButtonList>
                ...
                <tr>
                    <td colspan="3"><asp:Label ID="lblHelp" runat="server" cssClass="WizardText" resourcekey="IntroductionHelp" /></td>
                </tr>
                <tr>
                    <td style="width:20px"></td>
                    <td colspan="2">
