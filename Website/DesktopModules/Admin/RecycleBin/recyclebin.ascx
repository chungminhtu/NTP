        ...
        <td width="560">
            <asp:Panel ID="pnlTabs" runat="server" CssClass="WorkPanel" Visible="True">
                ...
                <table id="tblModules" cellspacing="0" cellpadding="0" width="525" summary="Basic Settings Design Table" border="0" runat="server">
                    <tr valign="Top">
                        <td width="250"><asp:ListBox ID="lstModules" runat="server" CssClass="Normal" Width="350px" Rows="5" DataTextField="ModuleTitle" DataValueField="ModuleId" SelectionMode="Multiple" /></td>
                        <td valign="top">
                    ...
                    <tr id="trTabLabel" runat="server">
                        <td class="SubHead" align="center"><dnn:Label ID="plTab" runat="server" ResourceKey="Tab" HelpKey="TabHelp" ControlName="cboTab"/></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr id="trTab" runat="server">
                        <td><asp:DropDownList ID="cboTab" CssClass="NormalTextBox" runat="server" Width="350" DataTextField="IndentedTabName" DataValueField="TabId" /></td>
                        <td>&nbsp;</td>
                    </tr>
                </table>
            </asp:Panel>
