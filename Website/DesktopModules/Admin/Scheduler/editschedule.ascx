...
<asp:Panel ID="pnlScheduleItem" runat="server">
    <table cellspacing="0" cellpadding="3" width="750" summary="Edit Schedule" border="0">
        <tr valign="top">
            ...
            <td class="Normal">
                <asp:TextBox ID="txtType" Width="450" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr valign="top">
            <td class="SubHead" width="150">
            ...
            <td class="Normal">
                <asp:CheckBox ID="chkEnabled" runat="server" Text="Yes" resourcekey="Yes"></asp:CheckBox>
            </td>
        </tr>
        <tr valign="top">
            <td class="SubHead" width="150">
        ...
        <tr valign="top">
            <td class="SubHead" width="150">
                <dnn:Label ID="plRetainHistoryNum" runat="server" ControlName="ddlRetainHistoryNum"
                    Text="Retain Schedule History:"></dnn:Label>
            </td>
            <td class="Normal">
        ...
        <tr valign="top">
            ...
            <td class="Normal">
                <asp:CheckBox ID="chkCatchUpEnabled" runat="server" Text="Yes" resourcekey="Yes">
                </asp:CheckBox>
            </td>
        </tr>
        <tr valign="top">
            <td class="SubHead" width="150">
                <dnn:Label ID="plObjectDependencies" runat="server" ControlName="txtObjectDependencies"
                    Text="Object Dependencies:"></dnn:Label>
            </td>
            <td class="Normal">
                <asp:TextBox ID="txtObjectDependencies" runat="server" MaxLength="150" Width="390"
        ...
        <tr valign="top">
            ...
            <td class="Normal">
                <asp:TextBox ID="txtServers" runat="server" MaxLength="150" Width="390" CssClass="NormalTextBox"></asp:TextBox>
            </td>
        </tr>
    </table>
    <p>
