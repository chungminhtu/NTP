...
<asp:panel id="pnlAddUser" runat="server" visible="False">
	<table id="tblAddUser" runat="server" width="350">
		<tr height="25">
	...
	<table id="tblPassword" runat="server" cellspacing="0" cellpadding="0" width="350" summary="Password Management" border="0">
		...
		<tr height="25">
			...
			<td style=""width:175px">
			    ...
			    <asp:Image ImageUrl="~/images/required.gif" BorderStyle="None" runat="server"/>a&nbsp;
			</td>
		</tr>
		<tr height="25">
			...
			<td style=""width:175px">
			    ...
			    <asp:Image  ImageUrl="~/images/required.gif" BorderStyle="None" runat="server"/>b&nbsp;
			</td>
		</tr>
		<tr id="trQuestion" runat="server" height="25" visible="false">
			...
			<td style=""width:175px">
			    ...
			    <asp:Image ImageUrl="~/images/required.gif" BorderStyle="None" runat="server"/>c&nbsp;
			</td>
		</tr>
		<tr id="trAnswer" runat="server" height="25" visible="false">
			...
			<td style=""width:175px">
			    ...
			    <asp:Image ImageUrl="~/images/required.gif" BorderStyle="None" runat="server"/>d&nbsp;
			</td>
		</tr>
		<tr>
...
<asp:panel id="pnlUpdate" runat="server" align="center">
    ...
    <asp:Button ID="Button1" runat="server" Height="24px" Text="Ghi lại" />
