                        ...
                        <td style="vertical-align:top; width:700px">
                            ...
                            <table id="tblSite" cellspacing="2" cellpadding="2" summary="Site Details Design Table" border="0" runat="server">
                                <tr>
                                    ...
                                    <td class="NormalTextBox" valign="top" style="width:550px"><asp:TextBox ID="txtPortalName" CssClass="NormalTextBox" runat="server" style="width:550px" MaxLength="128" /></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="NormalTextBox" style="width:550px"><asp:TextBox ID="txtDescription" CssClass="NormalTextBox" runat="server" style="width:550px" xLength="475" Rows="3" TextMode="MultiLine"/></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="NormalTextBox" style="width:550px"><asp:TextBox ID="txtKeyWords" CssClass="NormalTextBox" runat="server" style="width:550px" MaxLength="475" Rows="3" TextMode="MultiLine"/></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="NormalTextBox" style="width:550px"><asp:TextBox ID="txtFooterText" CssClass="NormalTextBox" runat="server" style="width:550px" MaxLength="100"/></td>
                                </tr>
							    <tr>
                            ...
                            <table id="tblMarketing" cellspacing="2" cellpadding="2" summary="Marketing Design Table" border="0" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td class="NormalTextBox" style="width:550px" nowrap>
                            ...
                            <table id="tblAppearance" cellspacing="2" cellpadding="2" summary="Appearance Design Table" border="0" runat="server">
                                <tr>
                                    ...
                                    <td style="width:550px"><dnn:URL ID="ctlLogo" runat="server" style="width:550px" ShowUrls="False" ShowTabs="False" ShowLog="False" ShowTrack="False" Required="False" /></td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:550px"><dnn:URL ID="ctlBackground" runat="server" style="width:550px" ShowUrls="False" ShowTabs="False" ShowLog="False" ShowTrack="False" Required="False"/></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td valign="top" style="width:550px"><dnn:Skin ID="ctlPortalSkin" runat="server" Width="450px" /></td>
                                </tr>
                                <tr>
                                    ...
                                    <td valign="top" style="width:550px"><dnn:Skin ID="ctlPortalContainer" runat="server" Width="450px"/></td>
                                </tr>
                                <tr>
                                    <td class="SubHead" style="width:250px"><dnn:Label ID="plAdminSkin" runat="server" Text="Admin Skin:" ControlName="ctlAdminSkin"/></td>
                                    <td valign="top" style="width:550px"><dnn:Skin ID="ctlAdminSkin" runat="server" Width="450px" /></td>
                                </tr>
                                <tr>
                                    ...
                                    <td valign="top" style="width:550px"><dnn:Skin ID="ctlAdminContainer" runat="server" Width="450px" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td style="vertical-align:top; width:600px">
                            ...
                            <table id="tblSecurity" cellspacing="2" cellpadding="2" summary="Security Settings Design Table" border="0" runat="server">
                                <tr>
                                    ...
                                    <td class="NormalTextBox" valign="top" style="width:550px">
                            ...
                            <table id="tblPages" cellspacing="2" cellpadding="2" summary="Page Management Design Table" border="0" runat="server">
                                <tr>
                                    ...
                                    <td class="NormalTextBox" valign="top" style="width:550px">
                                        <asp:DropDownList ID="cboSplashTabId" CssClass="NormalTextBox" runat="server" style="width:550px" DataTextField="IndentedTabName" DataValueField="TabId" /></td>
                                </tr>
                                <tr>
                                    <td class="SubHead" style="width:250px"><dnn:Label ID="plHomeTabId" runat="server" ControlName="cboHomeTabId" /></td>
                                    <td class="NormalTextBox" valign="top" style="width:550px"><asp:DropDownList ID="cboHomeTabId" CssClass="NormalTextBox" runat="server" style="width:550px" DataTextField="IndentedTabName" DataValueField="TabId" /></td>
                                </tr>
                                <tr>
                                    <td class="SubHead" style="width:250px"><dnn:Label ID="plLoginTabId" runat="server" ControlName="cboLoginTabId" /></td>
                                    <td class="NormalTextBox" valign="top" style="width:550px"><asp:DropDownList ID="cboLoginTabId" CssClass="NormalTextBox" runat="server" style="width:550px" DataTextField="IndentedTabName" DataValueField="TabId"/></td>
                                </tr>
                                <tr>
                                    <td class="SubHead" style="width:250px"><dnn:Label ID="plUserTabId" runat="server" ControlName="cboUserTabId" /></td>
                                    <td class="NormalTextBox" valign="top" style="width:550px"><asp:DropDownList ID="cboUserTabId" CssClass="NormalTextBox" runat="server" style="width:550px" DataTextField="IndentedTabName" DataValueField="TabId" /></td>
                                </tr>
                                <tr>
                                    <td class="SubHead" valign="top" style="width:250px"><dnn:Label ID="plHomeDirectory" runat="server" ControlName="txtHomeDirectory" /></td>
                                    <td class="NormalTextBox" style="width:550px"><asp:TextBox ID="txtHomeDirectory" CssClass="NormalTextBox" runat="server" style="width:550px" MaxLength="100" Enabled="False" /></td>
                                </tr>
                            </table>
                            <br/>
                            ...
                            <table id="tblPayment" cellspacing="2" cellpadding="2" summary="Payment Setttings Design Table" border="0" runat="server">
                                <tr>
                                    ...
                                    <td class="NormalTextBox" valign="top" style="width:550px"><asp:DropDownList ID="cboCurrency" CssClass="NormalTextBox" runat="server" style="width:550px" DataTextField="text" DataValueField="value" /></td>
                                </tr>
                                <tr>
                                    <td class="SubHead" valign="top" style="width:250px"><dnn:Label ID="plProcessor" runat="server" ControlName="cboProcessor" /></td>
                                    <td class="NormalTextBox" valign="top" style="width:550px">
                                        <asp:DropDownList ID="cboProcessor" CssClass="NormalTextBox" runat="server" style="width:550px" DataTextField="value" DataValueField="text" />
                                        <br />
                                ...
                                <tr>
                                    ...
                                    <td class="NormalTextBox" valign="top" style="width:550px"><asp:TextBox ID="txtUserId" CssClass="NormalTextBox" runat="server" style="width:550px" MaxLength="50" /></td>
                                </tr>
                                <tr>
                                    <td class="SubHead" style="width:250px"><dnn:Label ID="plPassword" runat="server" ControlName="txtPassword" /></td>
                                    <td class="NormalTextBox" valign="top" style="width:550px"><asp:TextBox ID="txtPassword" CssClass="NormalTextBox" runat="server" style="width:550px" MaxLength="50" TextMode="Password" /></td>
                                </tr>
                            </table>
                            <br/>
                            ...
                            <table id="tblUsability" cellspacing="2" cellpadding="2" summary="Usability Setttings Design Table" border="0" runat="server">
                                <tr>
                                    ...
                                    <td class="NormalTextBox" valign="top" style="width:550px"><asp:CheckBox ID="chkInlineEditor" runat="server" CssClass="Normal" /></td>
                                </tr>
                                <tr>
                            ...
                            <table id="tblOther" cellspacing="2" cellpadding="2" summary="Other Setttings Design Table" border="0" runat="server">
                                <tr>
                                    ...
                                    <td class="NormalTextBox" style="width:550px"><asp:DropDownList ID="cboAdministratorId" CssClass="NormalTextBox" runat="server" Width="300" DataTextField="FullName" DataValueField="UserId" /></td>
                                </tr>
                                <tr>
                                    <td class="SubHead" style="width:250px"><dnn:Label ID="plDefaultLanguage" runat="server" ControlName="cboDefaultLanguage" /></td>
                                    <td style="width:550px"><asp:DropDownList ID="cboDefaultLanguage" CssClass="NormalTextBox" runat="server" Width="300" /></td>
                                </tr>
                                <tr>
                                    <td class="SubHead" style="width:250px"><dnn:Label ID="plTimeZone" runat="server" ControlName="cboTimeZone" /></td>
                                    <td style="width:550px"><asp:DropDownList ID="cboTimeZone" CssClass="NormalTextBox" runat="server" Width="300" /></td>
                                </tr>
                            </table>
                            <br/>
                            ...
                            <table id="tblSSL" cellspacing="2" cellpadding="2" summary="SSL Settings Design Table" border="0" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td class="NormalTextBox" valign="top"><asp:TextBox ID="txtSSLURL" CssClass="NormalTextBox" runat="server" style="width:550px" /></td>
                                </tr>
                                <tr>
                                    <td class="SubHead" style="width:250px"><dnn:Label ID="plSTDURL" runat="server" ControlName="txtSTDURL" /></td>
                                    <td class="NormalTextBox" valign="top"><asp:TextBox ID="txtSTDURL" CssClass="NormalTextBox" runat="server" style="width:550px" /></td>
                                </tr>
                           </table>
                            <br/>
                            ...
                            <table id="tblHost" cellspacing="2" cellpadding="2" summary="Host Settings Design Table" border="0" runat="server">
                                <tr>
                                    ...
                                    <td class="NormalTextBox" style="width:550px">
                                ...
                                <tr>
                                    ...
                                    <td class="NormalTextBox" style="width:550px"><asp:TextBox ID="txtSiteLogHistory" CssClass="NormalTextBox" runat="server" Width="300" MaxLength="3" /></td>
                                </tr>
                                <tr>
