...
<asp:panel id="pnlLogin" runat="server" Visible="false">
    <table cellspacing="0" cellpadding="3" border="1" summary="SignIn Design Table" width="95%">
	    <tr>
	    ...
	    <tr>
		    <td id="tdPassword" runat="server" colspan="2" align="center"><asp:Linkbutton id="cmdPassword" resourcekey="cmdForgotPassword" cssclass="CommandButton" text="Quên mật khẩu?" runat="server" /></td>
            <td></td>
            <td></td>
	    </tr>
	    <tr>
