<%@ Control language="vb" Inherits="YourCompany.Modules.NTP_BN_TINHHINHTRIENKHAI_CTCL.EditNTP_BN_TINHHINHTRIENKHAI_CTCL" CodeFile="EditNTP_BN_TINHHINHTRIENKHAI_CTCL.ascx.vb" AutoEventWireup="false" Explicit="True" %>
