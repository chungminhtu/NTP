<%@ Control language="vb" Inherits="YourCompany.Modules.NTP_KD_PLAYMAU.ViewNTP_KD_PLAYMAU" CodeFile="ViewNTP_KD_PLAYMAU.ascx.vb" AutoEventWireup="false" Explicit="True" %>
...
<fieldset class="ntp_fieldset" style="width: 813px">
        <legend class="ntp_legend">Danh sách phiếu lấy mẫu kiểm định tiêu bản </legend>
         <table class="ntp_table_main" style="width: 820px">
             <tr>
                 <td style="width: 11%">
                 ...
                 <td colspan="2">
                     <asp:DropDownList ID="CboDMTinh" runat="server" CssClass="ntp_combobox" DataTextField="TEN_TINH"
                         DataValueField="MA_TINH" TabIndex="1" Width="190px">
                     </asp:DropDownList></td>
                 <td style="width: 16%">
                 </td>
                 <td style="width: 20%">
