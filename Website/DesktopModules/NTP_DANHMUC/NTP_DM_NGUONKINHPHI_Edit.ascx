<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NTP_DM_NGUONKINHPHI_Edit.ascx.vb" Inherits="NTP_DM_NGUONKINHPHI_Edit" %>
...
<table width="100%" class = "ntp_table_main">
    <tr>
        ...
        <td colspan="2" width="80%">
            <asp:TextBox ID="txtMO_TA" runat="server" CssClass="ntp_textbox" Width="500px" TabIndex="1" MaxLength="50"></asp:TextBox>
            <asp:TextBox ID="txtID_NGUONKINHPHI" runat="server" CssClass="ntp_textbox" Visible="False"
