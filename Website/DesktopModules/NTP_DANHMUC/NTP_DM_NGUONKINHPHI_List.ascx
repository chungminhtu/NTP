<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NTP_DM_NGUONKINHPHI_List.ascx.vb" Inherits="NTP_DM_NGUONKINHPHI_List" %>
...
<asp:ImageButton id="cmdEdit" runat="server" __designer:wfdid="w4" CommandName="edit" ImageUrl="~/images/edit.gif"></asp:ImageButton>
                    ...
                    <asp:BoundColumn DataField="ID_NGUONKINHPHI" HeaderText="ID_DVT" Visible="False"></asp:BoundColumn>
                    <asp:BoundColumn DataField="MO_TA" HeaderText="M&#244; tả">
