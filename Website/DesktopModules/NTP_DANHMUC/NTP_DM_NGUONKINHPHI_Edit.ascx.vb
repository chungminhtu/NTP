...
Public Class NTP_DM_NGUONKINHPHI_Edit
    Inherits DotNetNuke.Entities.Modules.ModuleSettingsBase

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim obj As New NTP_DANHMUC.NTP_DM_NGUONKINHPHI_BO
        Dim inf As New NTP_DANHMUC.NTP_DM_NGUONKINHPHI_Info
        Try
            ...
            If Not IsPostBack Then
                If Not Request.QueryString("id") Is Nothing Then
                    Me.txtID_NGUONKINHPHI.Text = Request.QueryString("id")
                    inf = obj.SelectItem(Me.txtID_NGUONKINHPHI.Text)
    ...
    Protected Sub cmdSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Try
            ...
            Else
                'Update
                inf.ID_NGUONKINHPHI = Me.txtID_NGUONKINHPHI.Text
                obj.UpdateItem(inf)
            End If
