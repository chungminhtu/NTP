<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NTP_DM_LYDO_NHAPXUAT_List.ascx.vb" Inherits="NTP_DM_LYDO_NHAPXUAT_List" %>
...
<asp:ImageButton id="cmdEdit" runat="server" __designer:wfdid="w4" CommandName="edit" ImageUrl="~/images/edit.gif"></asp:ImageButton>
                    ...
                    <asp:BoundColumn DataField="TYPE" HeaderText="Loại">
