<%@ Control language="vb" Inherits="YourCompany.Modules.NTP_BN_DM_NOIGIOITHIEU.ViewNTP_BN_DM_NOIGIOITHIEU" CodeFile="ViewNTP_BN_DM_NOIGIOITHIEU.ascx.vb" AutoEventWireup="false" Explicit="True" %>
...
<asp:ImageButton id="cmdEdit" runat="server" CommandName="edit" ImageUrl="~/images/edit.gif"></asp:ImageButton>
                    ...
                    <asp:BoundColumn DataField="ID_NoiGioiThieu" HeaderText="ID_NoiGioiThieu" Visible="False"></asp:BoundColumn>
                 
                    <asp:BoundColumn DataField="ten_NoiGioiThieu" HeaderText="Phân loại y tế">
