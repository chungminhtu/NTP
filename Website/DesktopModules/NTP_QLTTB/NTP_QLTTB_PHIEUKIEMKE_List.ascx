<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NTP_QLTTB_PHIEUKIEMKE_List.ascx.vb" Inherits="NTP_QLTTB_PHIEUKIEMKE_List" %>
...
<asp:Panel ID="pnlAll" runat=server>
 <table  class = "ntp_table_main">
     ...
     <tr>
         <td width="20%">
             <asp:Label ID="Label3" runat="server" CssClass="ntp_label" Text="Ngày kiểm kê (từ ngày)"></asp:Label></td>
         <td width="30%">
            ...
            <td colspan="4" width="100%">
                <cc3:MultiSelectGrid ID="grdDS" runat="server" AutoGenerateColumns="False" AllowPaging="True" ShowFooter="True" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            <itemtemplate>
<asp:ImageButton id="cmdEdit" runat="server" __designer:wfdid="w3" CommandName="edit" ImageUrl="~/images/edit.gif" CausesValidation="False"></asp:ImageButton> 
</itemtemplate>
                            <headerstyle width="2%" />
                        </asp:TemplateColumn>
                        <asp:BoundColumn DataField="ID_KIEMKE" HeaderText="ID Phiếu">
                            <headerstyle width="10%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="TRANG_THAI" HeaderText="TRANG_THAI" Visible="False"></asp:BoundColumn>
                        <asp:BoundColumn DataField="NGAY_KIEMKE" HeaderText="Ng&#224;y kiểm k&#234;" DataFormatString="{0:dd/MM/yyyy}">
                            <headerstyle width="15%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="NGUOI_KIEMKE" HeaderText="Người lập phiếu" Visible="False">
                            <headerstyle width="15%" />
                        </asp:BoundColumn>
