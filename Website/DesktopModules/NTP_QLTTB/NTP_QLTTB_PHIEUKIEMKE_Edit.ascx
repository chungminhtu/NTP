<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NTP_QLTTB_PHIEUKIEMKE_Edit.ascx.vb" Inherits="NTP_QLTTB_PHIEUKIEMKE_Edit" %>
...
<fieldset class="ntp_fieldset">
    ...
    <tr>
        <td width="20%" style="height: 26px">
            <asp:Label ID="Label3" runat="server" CssClass="ntp_label" Text="Trang thiết bị"></asp:Label>
            <asp:Label ID="Label10" runat="server" CssClass="ntp_require" Text="*"></asp:Label></td>
        <td colspan="2" width="80%" style="height: 26px"><asp:DropDownList ID="cboTHIETBI" runat="server" CssClass="ntp_combobox" DataTextField="TEN_THIETBI"
                DataValueField="ID_THIETBI" Width="50%" TabIndex="7">
        </asp:DropDownList>
    ...
    <tr>
        ...
        <td colspan="2" width="80%">
            ...
            <asp:Button ID="cmdDelete" runat="server" CssClass="ntp_button" Text="Trang thiết bị" Width="100px" CausesValidation="False" TabIndex="12" />
...
<asp:ImageButton id="cmdEdit" runat="server" CausesValidation="False" ImageUrl="~/images/edit.gif" CommandName="edit" __designer:wfdid="w2"></asp:ImageButton> 
        ...
        <asp:BoundColumn DataField="TEN_TRANGTHAI" HeaderText="Trạng th&#225;i">
            <headerstyle width="10%" />
        </asp:BoundColumn>
    </Columns>
