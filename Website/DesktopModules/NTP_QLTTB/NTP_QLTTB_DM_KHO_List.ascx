<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NTP_QLTTB_DM_KHO_List.ascx.vb" Inherits="NTP_QLTTB_DM_KHO_List" %>
...
<asp:Panel ID="pnlAll" runat="server">
    <table class="ntp_table_main">
        ...
        <tr>
            ...
            <td width="60%">
                <cc4:autosuggestbox id="txtSearhKhoCapTren" runat="server" cssclass="ntp_textbox" DataPage="NTP_QLTTB_DM_KHO_Search.aspx" ResourcesDir="/asb_includes"  ></cc4:autosuggestbox>
            </td>
            <td width="20%">
