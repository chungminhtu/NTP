<%@ Control language="vb" Inherits="YourCompany.Modules.NTP_BAOCAOTUYENTINH.EditNTP_BAOCAOTUYENTINH" CodeFile="EditNTP_BAOCAOTUYENTINH.ascx.vb" AutoEventWireup="false" Explicit="True" %>
