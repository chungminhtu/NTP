<%@ Control language="vb" Inherits="YourCompany.Modules.NTP_BN_DM_NGUONNHANLUC.ViewNTP_BN_DM_NGUONNHANLUC" CodeFile="ViewNTP_BN_DM_NGUONNHANLUC.ascx.vb" AutoEventWireup="false" Explicit="True" %>
...
<asp:ImageButton id="cmdEdit" runat="server" CommandName="edit" ImageUrl="~/images/edit.gif"></asp:ImageButton>
                    ...
                    <asp:BoundColumn DataField="ID_NguonNhanLuc" HeaderText="ID_NguonNhanLuc" Visible="False"></asp:BoundColumn>
                 
                    <asp:BoundColumn DataField="ten_NguonNhanLuc" HeaderText="T&#234;n nguồn nhân lực">
                        <headerstyle width="50%" />
                    </asp:BoundColumn>
                   <asp:BoundColumn DataField="PhanLoai" HeaderText="Phân loại">
