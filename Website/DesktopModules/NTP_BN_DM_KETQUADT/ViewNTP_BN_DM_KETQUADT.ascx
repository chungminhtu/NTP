<%@ Control language="vb" Inherits="YourCompany.Modules.NTP_BN_DM_KETQUADT.ViewNTP_BN_DM_KETQUADT" CodeFile="ViewNTP_BN_DM_KETQUADT.ascx.vb" AutoEventWireup="false" Explicit="True" %>
...
<asp:ImageButton id="cmdEdit" runat="server" CommandName="edit" ImageUrl="~/images/edit.gif"></asp:ImageButton>
                    ...
                    <asp:BoundColumn DataField="ID_KetQuaDT" HeaderText="ID_KetQuaDT" Visible="False"></asp:BoundColumn>
                 
                    <asp:BoundColumn DataField="ten_KetQuaDT" HeaderText="T&#234;n kết quả điều trị">
