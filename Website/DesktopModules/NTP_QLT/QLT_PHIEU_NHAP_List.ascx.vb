...
Partial Class QLT_PHIEU_NHAP_List
    ...
    '    Try
    '        '   Me.grdDS.DataSource = obj.Search(sMaThuoc, sTenThuoc)
    ...
    Protected Sub grdDS_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles grdDS.ItemCommand
        If e.CommandName = "edit" Then
            Response.Redirect(NavigateURL("edit", "mid=" & Me.ModuleId & "&id=" & e.Item.Cells(2).Text & "&TrangThai=" & e.Item.Cells(10).Text))  '_
