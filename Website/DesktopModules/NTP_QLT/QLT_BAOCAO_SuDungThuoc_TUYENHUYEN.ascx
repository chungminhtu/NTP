<%@ Control Language="VB" AutoEventWireup="false" CodeFile="QLT_BAOCAO_SuDungThuoc_TUYENHUYEN.ascx.vb" Inherits="QLT_BAOCAO_SUDUNGTHUOC_TUYENHUYEN" %>
<table class="ntp_table_main" width="100%">
    ...
    <tr>
        <td width="15%">
            <asp:Label ID="Label2" runat="server" CssClass="ntp_label" Text="Quý"></asp:Label></td>
        <td width="85%">
