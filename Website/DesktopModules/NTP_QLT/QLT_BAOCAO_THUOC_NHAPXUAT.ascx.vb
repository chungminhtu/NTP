...
Partial Class QLT_BAOCAO_THUOC_NHAPXUAT
    Inherits DotNetNuke.Entities.Modules.ModuleSettingsBase

    Private Sub BindComboMonth()
        Me.cboThang.Items.Add(New ListItem("Thang 1", 1))
        Me.cboThang.Items.Add(New ListItem("Thang 2", 2))
        Me.cboThang.Items.Add(New ListItem("Thang 3", 3))
        Me.cboThang.Items.Add(New ListItem("Thang 4", 4))
    ...
    Private Sub BaoCao(ByVal Nam As Integer, ByVal Thang As Integer)
        'Xem bao cao kiem ke
        Dim url As String
        url = Request.ApplicationPath & "/DesktopModules/NTP_QLT/QLT_BAOCAO_THUOC_NHAPXUAT_rpt.aspx?Nam=" & Nam & "&Thang=" & Thang & "&ID_KHO=" & Me.CurrentUserStock.ID_KHO_THUOC
