<%@ Control language="vb" Inherits="YourCompany.Modules.NTP_KD_BAOCAOTUYENTINH.EditNTP_KD_BAOCAOTUYENTINH" CodeFile="EditNTP_KD_BAOCAOTUYENTINH.ascx.vb" AutoEventWireup="false" Explicit="True" %>
