...
<%@ Register     Assembly="AjaxControlToolkit"     Namespace="AjaxControlToolkit"     TagPrefix="ajaxToolkit" %>
    ...
    <fieldset class="ntp_fieldset" style="height: 868px">
        ...
        <table style="width: 768px">
          ...
          <asp:Panel ID="Panel1" runat="server" Height="10px" Width="751px" BackColor="Transparent" BorderColor="Gainsboro" BorderStyle="Ridge" BorderWidth="1px"><table style="width: 764px">
            <tr>
                    <td style="width: 76px">
                    </td>
            ...
            <asp:Panel ID="Panel2" runat="server" Height="91px" Width="762px">
                ...
                <cc3:MultiSelectGrid ID="grdDS" runat="server" AllowPaging="True" AlternatingItemStyle-CssClass="ntp_grd_AltRowStyle"
                    ...
                    SelectedItemStyle-CssClass="ntp_grd_SelectedRowStyle" ShowFooter="True" Width="100%" height="39px" pagesize="5" bordercolor="Teal" borderwidth="1px" cellpadding="0" tabindex="17"><Columns>
<asp:TemplateColumn>
...
<HeaderStyle CssClass="ntp_grd_HeaderStyle"></HeaderStyle>
            ...
            <table style="width: 764px; height: 43px;" border="0">
                <tr>
 ...
 <asp:Panel ID="Panelcmd" runat="server" Height="30px" Width="798px">
