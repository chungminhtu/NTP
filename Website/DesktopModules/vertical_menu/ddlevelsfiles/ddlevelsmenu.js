...
effects: {enableswipe: true, enablefade: true, duration: 800},
...
init:function(mainmenuid, dir,serverpath){
    
    //init lai
    this.arrowpointers.rightarrow[0] = serverpath  + this.arrowpointers.rightarrow[0];
    this.arrowpointers.downarrow[0] = serverpath  + this.arrowpointers.downarrow[0];
    //alert (this.arrowpointers.rightarrow);
...
setup:function(mainmenuid, dir,serverpath){
    //alert(serverpath)
	this.addEvent(window, function(){ddlevelsmenu.init(mainmenuid, dir,serverpath)}, "load")
}
