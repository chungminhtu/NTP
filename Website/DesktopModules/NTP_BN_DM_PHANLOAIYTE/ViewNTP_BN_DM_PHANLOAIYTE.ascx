<%@ Control language="vb" Inherits="YourCompany.Modules.NTP_BN_DM_PHANLOAIYTE.ViewNTP_BN_DM_PHANLOAIYTE" CodeFile="ViewNTP_BN_DM_PHANLOAIYTE.ascx.vb" AutoEventWireup="false" Explicit="True" %>
...
<asp:ImageButton id="cmdEdit" runat="server" CommandName="edit" ImageUrl="~/images/edit.gif"></asp:ImageButton>
                    ...
                    <asp:BoundColumn DataField="ID_PHANLOAIYTE" HeaderText="ID_PHANLOAIYTE" Visible="False"></asp:BoundColumn>
                 
                    <asp:BoundColumn DataField="ten_PHANLOAIYTE" HeaderText="T&#234;n phân loại y tế">
