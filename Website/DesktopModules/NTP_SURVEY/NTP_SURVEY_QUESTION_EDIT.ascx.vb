...
Public Class NTP_SURVEY_QUESTION_EDIT
    ...
    '    '            Me.txtSURVEY_ID.Text = Request.QueryString("id")
    '    '            inf = obj.SelectItem(Me.txtSURVEY_ID.Text)
    '    '            Me.txtVIEW_ORDER.Text = inf.MA_PHIEUNHAP
    ...
    '    '            End If
    '    '            Me.txtSURVEY_ID.Enabled = False
    '    '            Me.pnlDetail.Visible = True
    '    '            'BindDetail
    '    '            BindGrid(Me.txtSURVEY_ID.Text)
    ...
    '    '        End If
    '    '        NTP_Common.SetFormFocus(Me.txtVIEW_ORDER, Me.ModuleConfiguration.ModuleControl.SupportsPartialRendering)
    '    '    End If
    ...
    ''    '    inf.MA_PHIEUNHAP = Me.txtVIEW_ORDER.Text
    ...
    ''    '        'Add
    ''    '        Me.txtSURVEY_ID.Text = obj.InsertItem(inf)
    ''    '        'Clear text box
    ''    '        'Me.txtMA_PHIEU.Text = ""
    ...
    ''    '    Else
    ''    '        'Update
    ''    '        inf.ID_PHIEUNHAP = Me.txtSURVEY_ID.Text
    ''    '        obj.UpdateItem(inf)
    ''    '    End If
    ...
    ''    '    If Me.txtSURVEY_OPTION_ID.Text.Trim = "" Then
    ''    '        'Add
    ''    '        obj.InsertItem(inf)
    ''    '    Else
    ''    '        'Update
    ''    '        inf.ID_PHIEUNHAP_CHITIET = Me.txtSURVEY_OPTION_ID.Text
    ''    '        obj.UpdateItem(inf)
    ''    '    End If
    ''    '    NTP_Common.SetFormFocus(Me.cboVATTU, Me.ModuleConfiguration.ModuleControl.SupportsPartialRendering)
    ...
    ''            'Get detail
    ''            Me.txtSURVEY_OPTION_ID.Text = inf.ID_PHIEUNHAP_CHITIET
    ...
    ''    Me.txtSURVEY_ID.Text = ""
    ''    Me.txtSURVEY_OPTION_ID.Text = ""
    ''    Me.txtVIEW_ORDER.Text = ""
