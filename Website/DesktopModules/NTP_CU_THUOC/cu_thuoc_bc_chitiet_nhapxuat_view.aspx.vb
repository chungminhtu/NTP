...
Public Class cu_thuoc_bc_chitiet_nhapxuat_view
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        id_thuoc = Request.QueryString("id_thuoc")
        ...
        sPath = Me.Request.PhysicalApplicationPath & NTP_Common.Configuration.ReportDirectory & "\cu_thuoc_bc_chitiet_nhapxuat.rpt"
        rpt.Load(sPath)
