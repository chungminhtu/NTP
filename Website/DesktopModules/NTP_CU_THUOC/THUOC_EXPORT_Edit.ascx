<%@ Control Language="VB" AutoEventWireup="false" CodeFile="THUOC_EXPORT_Edit.ascx.vb" Inherits="THUOC_EXPORT_Edit" %>
...
<asp:Panel ID="pnlDetail" runat="server" DefaultButton="cmdSave" Width="100%">
    <fieldset class="ntp_fieldset">
        ...
        <table class="ntp_table_main" width="100%">
            ...
            <tr>
                <td width="20%">
                    <asp:Label ID="Label3" runat="server" CssClass="ntp_label" Text="Thuốc"></asp:Label>
                ...
                <td style="width: 30%">
                    <asp:DropDownList ID="cboThuoc" runat="server" CssClass="ntp_combobox" DataTextField="TEN_THUOC"
                        DataValueField="ID_THUOC" TabIndex="10" Width="100%">
                    </asp:DropDownList></td>
                <td width="20%">
                </td>
                <td width="30%">
            ...
            <tr>
                ...
                <td style="; width: 30%;">
                    <asp:TextBox ID="LO_SX" runat="server" CssClass="ntp_textbox" MaxLength="50" TabIndex="12"
                ...
                <td style="" width="30%">
                    <asp:TextBox ID="HAN_DUNG" runat="server" CssClass="ntp_textbox" MaxLength="50" TabIndex="14"
                        Width="150px"></asp:TextBox>
                    ...
                    <ajaxToolkit:MaskedEditValidator ID="Maskededitvalidator2" runat="server" ControlExtender="Maskededitextender2"
                        ControlToValidate="HAN_DUNG" Display="Dynamic" EmptyValueMessage="Bạn phải nhập ngày"
                        InvalidValueMessage="Định dạng ngày không đúng" IsValidEmpty="False" MaximumValue="31/12/9999"
                        MaximumValueMessage="Bạn chỉ được nhập ngày trong khoảng (1/1/1753 - 31/12/9999)"
                        MinimumValue=" 1/1/1753" MinimumValueMessage="Bạn chỉ được nhập ngày trong khoảng (1/1/1753 - 31/12/9999)"
                        SetFocusOnError="True" TooltipMessage="Nhập ngày"></ajaxToolkit:MaskedEditValidator>
                    <asp:LinkButton ID="cmdCheckLo" runat="server">Kiểm tra lô</asp:LinkButton></td>
            </tr>
            <tr>
                <td width="20%">
            ...
            <tr>
                ...
                <td colspan="3" width="60%">
                    ...
                    <ajaxToolkit:ConfirmButtonExtender ID="cbe" runat="server" ConfirmText="Bạn cần có chắc thông tin về lô sản xuất và hạn sử dụng được nhập chính xác?"
