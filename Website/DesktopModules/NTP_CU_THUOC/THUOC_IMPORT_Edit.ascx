<%@ Control Language="VB" AutoEventWireup="false" CodeFile="THUOC_IMPORT_Edit.ascx.vb" Inherits="THUOC_IMPORT_Edit" %>
    ...
    <table width="100%" class = "ntp_table_main">
        ...
        <tr>
            ...
            <td  width="30%">
                ...
                DataValueField="ID_THUOC" Width="100%" TabIndex="10">
        </asp:DropDownList></td>
            <td width="20%">
                <asp:Label ID="Label8" runat="server" CssClass="ntp_label">Lý do nhập</asp:Label></td>
            <td width="30%">
