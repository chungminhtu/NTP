<%@ Control Language="VB" AutoEventWireup="false" CodeFile="THUOC_EXPORT_List.ascx.vb" Inherits="THUOC_EXPORT_List" %>
...
<asp:ImageButton id="cmdEdit" runat="server" __designer:wfdid="w6" CommandName="edit" ImageUrl="~/images/edit.gif" CausesValidation="False"></asp:ImageButton> 
                        ...
                        <asp:BoundColumn DataField="HAN_DUNG" HeaderText="Hạn D&#249;ng" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundColumn>
