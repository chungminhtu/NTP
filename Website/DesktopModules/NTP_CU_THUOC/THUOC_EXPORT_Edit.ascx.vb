...
Public Class THUOC_EXPORT_Edit
    ...
    Private Sub SetInfo(ByVal ID As Integer)
        Dim obj As New NTP_QLT.NTP_CU_THUOC_EXPORT_BO
        Dim inf As New NTP_QLT.NTP_CU_THUOC_EXPORT_Info
    ...
    Private Function GetInfo() As NTP_QLT.NTP_CU_THUOC_EXPORT_Info
        Dim inf As New NTP_QLT.NTP_CU_THUOC_EXPORT_Info
