...
Partial Class THUOC_KHO_BC_CHITIET_NHAPXUAT
    ...
    Private Sub BindComboThuoc()
        Try
            cboThuoc.DataSource = (New NTP_DANHMUC.NTP_DM_THUOC_BO).SelectAllItems
            cboThuoc.DataBind()
    ...
    Protected Sub cmdView_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdView.Click
        ...
        url = Request.ApplicationPath & "/DesktopModules/NTP_CU_THUOC/cu_thuoc_bc_chitiet_nhapxuat_view.aspx?ID_KHO=" & Me.CurrentUserStock.ID_KHO_THUOC & "&thang=" & ky & "&NAM=" & txtNam.Text.Trim & "&ID_NGUONKP=" & cboNguonKP.SelectedValue & "&ID_THUOC=" & cboThuoc.SelectedValue   ' "./DesktopModules/VTP_VIEWREPORT/ShowReport.aspx"
