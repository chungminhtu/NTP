...
Public Class THUOC_KHO_BC_SUDUNG_VIEW
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        sPath = Me.Request.PhysicalApplicationPath & NTP_Common.Configuration.ReportDirectory & "\cu_thuoc_bc_sudungthuoc_donvi.rpt"
        rpt.Load(sPath)
