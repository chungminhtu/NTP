<%@ Control language="vb" Inherits="YourCompany.Modules.NTP_KD_BAOCAOHDXN.EditNTP_KD_BAOCAOHDXN" CodeFile="EditNTP_KD_BAOCAOHDXN.ascx.vb" AutoEventWireup="false" Explicit="True" %>
