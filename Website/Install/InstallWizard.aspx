        ...
        <asp:Wizard ID="wizInstall" runat="server" CssClass="Wizard" ActiveStepIndex="0" 
            ...
            <WizardSteps>
                ...
                <asp:WizardStep ID="Step4" runat="server" Title="HostSettings">
                    ...
                    <table>
                        <tr>
                            <td class="NormalBold" style="width: 250px"><asp:Label ID="lblSMTPServer" runat="server" /></td>
                            <td class="Normal" align="left"><asp:TextBox ID="txtSMTPServer" runat="server" MaxLength="256" Width="225" /></td>
                        </tr>
                        <tr>
                            <td class="NormalBold" style="width: 250px"><asp:Label ID="lblSMTPAuthentication" runat="server" /></td>
                            <td class="Normal">
                                <asp:RadioButtonList ID="optSMTPAuthentication" runat="server" RepeatDirection="Horizontal" AutoPostBack="true">
                        ...
                        <tr>
                            <td class="NormalBold" style="width: 250px"><asp:Label ID="lblSMTPEnableSSL" runat="server" /></td>
                            <td class="Normal"><asp:CheckBox ID="chkSMTPEnableSSL" runat="server" /></td>
                        </tr>
                        <tr id="trSMTPUserName" runat="server">
                            <td class="NormalBold" style="width: 250px"><asp:Label ID="lblSMTPUsername" runat="server" /></td>
                            <td class="Normal"><asp:TextBox ID="txtSMTPUsername" runat="server" MaxLength="256" Width="300" /></td>
                        </tr>
                        <tr id="trSMTPPassword" runat="server">
                            <td class="NormalBold" style="width: 250px"><asp:Label ID="lblSMTPPassword" runat="server" /></td>
                            <td class="Normal"><asp:TextBox ID="txtSMTPPassword" runat="server" MaxLength="256" Width="300" TextMode="Password" /></td>
                        </tr>
                    </table>
                ...
                <asp:WizardStep ID="Step6" runat="server" Title="Skins">
                ...
                <asp:WizardStep ID="Step7" runat="server" Title="Languages">
                ...
                <asp:WizardStep ID="Step8" runat="server" Title="AuthSystems">
                ...
                <asp:WizardStep ID="Step9" runat="server" Title="Providers">
