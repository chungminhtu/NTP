			...
			<table cellspacing="1" cellpadding="1" style="width:100%;">
				<tr id="rowControlPanel" runat="server">
					...
					<td style="border-left:1px #CCCCCC dotted; border-right:1px #CCCCCC dotted; border-top:1px #CCCCCC dotted; text-align:center; vertical-align:top; width:50%;">
						...
						<table cellspacing="1" cellpadding="0" border="0" style="margin: 0 auto;">
							<tr>
								<td align="center">
									<table cellspacing="1" cellpadding="0" border="0">
							            <tr style="vertical-align:bottom">
											<td class="SubHead" style="text-align:right; white-space: nowrap;"><asp:Label ID="lblModule" Runat="server" enableviewstate="False" />&nbsp;</td>
											<td style="white-space: nowrap;">
											    <asp:dropdownlist id="cboTabs" runat="server" cssclass="NormalTextBox" Width="250px" datavaluefield="TabID" datatextfield="TabName" visible="False" autopostback="True" />
												<asp:dropdownlist id="cboDesktopModules" runat="server" cssclass="NormalTextBox" Width="250px" datavaluefield="DesktopModuleID" datatextfield="FriendlyName"/>&nbsp;&nbsp;
											</td>
											<td class="SubHead" style="text-align:right; white-space: nowrap;"><asp:Label ID="lblPane" Runat="server" enableviewstate="False" />&nbsp;</td>
							            ...
							            <tr style="vertical-align:bottom">
											<td class="SubHead"  style="text-align:right; white-space: nowrap;"><asp:Label ID="lblTitle" Runat="server" enableviewstate="False"/>&nbsp;</td>
											<td style="white-space: nowrap;">
											...
											<td class="SubHead" style="text-align:right; white-space: nowrap;"><asp:Label ID="lblPosition" Runat="server" resourcekey="Position" enableviewstate="False" />&nbsp;</td>
											<td style="white-space: nowrap;">
							            ...
							            <tr style="vertical-align:bottom">
											<td class="SubHead" style="text-align:right; white-space: nowrap;"><asp:Label ID="lblPermission" Runat="server" resourcekey="Permission" enableviewstate="False" />&nbsp;</td>
											<td style="white-space: nowrap;">
											...
											<td class="SubHead" style="text-align:right; white-space: nowrap;"><asp:Label ID="lblAlign" Runat="server" enableviewstate="False" />&nbsp;</td>
											<td style="white-space: nowrap;">
                        ...
                        <asp:Label ID="lblCommonTasks" Runat="server" CssClass="SubHead" enableviewstate="False"/>
						 <table  border="0" cellpadding="2" cellspacing="0" style="margin: 0 auto;">
							...
							<tr valign="bottom">
								...
								<td style="width:35px;" align="center" class="Normal"><asp:Hyperlink ID="cmdHelp" Runat="server" CssClass="CommandButton"  Target="_new"/></td>
