...
<table class="Settings" cellspacing="2" cellpadding="2" style="width:760px" summary="Module Settings Design Table" border="0">
	<tr>
		<td style="width:760px" valign="top">
				...
				<tr>
					...
					<td valign="top" style="width:675px">
						...
						<table id="tblDetails" cellspacing="2" cellpadding="2" summary="Appearance Design Table" border="0" runat="server">
							...
							<tr>
								<td class="SubHead" style="width:150px" valign="top" colspan="2"><br>
					...
					<td valign="top" style="width:675px">
						...
						<table id="tblAppearance" cellspacing="2" cellpadding="2" summary="Appearance Design Table" border="0" runat="server">
							<tr>
								...
								<td style="width:475px"><dnn:url id="ctlIcon" runat="server" style="width:475px" ShowImages="true" showurls="False" showtabs="False" showlog="False" showtrack="False" required="False" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td valign="top"><dnn:skin id="ctlModuleContainer" runat="server" Width="450px"></dnn:skin></td>
							</tr>
							<tr id="rowCache" runat="Server">
								<td class="SubHead" style="width:200px" valign="top"><dnn:label id="plCacheTime" runat="server" controlname="txtCacheTime" /></td>
								<td>
									<asp:textbox id="txtCacheTime" runat="server" cssclass="NormalTextBox" style="width:450px" columns="10" maxlength="6" />
									<asp:CompareValidator ID="valCacheTime" ControlToValidate="txtCacheTime" Operator="DataTypeCheck" Type="Integer" Runat="server" Display="Dynamic" resourcekey="valCacheTime.ErrorMessage" />
								</td>
							</tr>
						</table>
						<br/>
						...
						<table id="tblOther" cellspacing="2" cellpadding="2" summary="Security Details Design Table" border="0" runat="server">
							...
							<tr>
								...
								<td>
								    <asp:label ID="lblTab" runat="server" CssClass="Normal" />
			...
			<br/>
			<dnn:sectionhead id="dshSpecific" cssclass="Head" runat="server" text="Module Specific Settings" section="tblSpecific" isexpanded="False" includerule="True" />
