Sys.UI._ModalUpdateProgress = function Sys$UI$_ModalUpdateProgress(element) {
    ...
    function Sys$UI$_ModalUpdateProgress$_attachPopup() {
        ...
        //$addHandler(window, 'onscroll', this._scrollHandler);
    ...
    function getScrollXY() {
      ...
      //return [ scrOfX, scrOfY ];
       arrayScrollXY = new Array(scrOfX,scrOfY);
      return arrayScrollXY;
    }
    
    function setObjectOnScroll() {
        //alert('IE' + this._backgroundElement);
        alert(document.getElementById('divbackground').style.width);
    }
    ...
    function Sys$UI$_ModalUpdateProgress$_layout() {
        ...
        */
        ...
        scrollLeft=arrayScrollXY[0];
        scrollTop=arrayScrollXY[1];
             
        clientWidth=arrayWindowSize[0];
        clientHeight=arrayWindowSize[1];
    ...
    function onscrollshow()
    {
        ...
        */
        ...
        //alert(clientWidth);
        //alert(clientHeight);
        //alert(document.getElementById('divbackground'));
        //alert(this._foregroundElement);
        document.getElementById('divbackground').style.left = scrollLeft+'px';
        document.getElementById('divbackground').style.top = scrollTop+'px';
        document.getElementById('divbackground').style.width = clientWidth+'px';
        document.getElementById('divbackground').style.height = clientHeight+'px';           
        document.getElementById('ModalUpdateProgress1').style.left = scrollLeft+((clientWidth-document.getElementById('ModalUpdateProgress1').offsetWidth)/2)+'px';
        document.getElementById('ModalUpdateProgress1').style.top = scrollTop+((clientHeight-document.getElementById('ModalUpdateProgress1').offsetHeight)/2)+'px';
    ...
    function Sys$UI$_ModalUpdateProgress$initialize() {
        ...
        this._backgroundElement.id='divbackground';
        this._backgroundElement.style.display = 'none';
        ...
        window.onscroll=function(){onscrollshow()};
